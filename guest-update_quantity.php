...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT price, quantity FROM tbl_guestorders WHERE product_name = '$product_name' AND email = '$email'";
        ...
        if ($stock_result->num_rows > 0) {
            ...
            if (isset($_POST['decrease'])) {
                if ($current_quantity > 1) {
                    ...
                    $query = "UPDATE tbl_guestorders SET quantity = $new_quantity, total = '$total' WHERE product_name = '$product_name' AND email = '$email'";
                } else {
                ...
                if ($current_quantity < $available_stock) {
                    ...
                    header("Location: guest-Cart.php"); // Redirect back to cart page
                    exit();
                }
            }
