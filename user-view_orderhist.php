                            ...
                            <h4><b><?php echo $Status ?></b></h4>
                                ...
                                <div class="well">
                                                ...
                                                <?php if ($Status !== "Completed") : ?>
                                                    <a href="user-delete_orders.php?ordernum=<?php echo $Ref_no; ?>" class="btn btn-outline-primary btn-lg rounded w-lg mt-3">Cancel order</a>
                                                <?php endif; ?>

                                                <a href="<?php echo ($Status === 'Completed') ? 'user-OrderHistory.php' : 'user-Orders.php'; ?>" class="btn btn-primary btn-lg rounded w-lg mt-3">Back</a>
