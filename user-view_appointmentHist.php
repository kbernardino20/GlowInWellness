...
<?php 
    ...
    if (isset($_GET['Ref_No']) )  {
        ...
        $search_query = "SELECT * FROM tbl_bookinghistory WHERE Ref_No = '$Ref_No'";
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-sm-9">
                                        <div class="well">
                                                ...
                                                <br>
                                                <a href="user-TransactionHistory.php" class="btn btn-primary btn-lg rounded w-lg mt-3">Close</a>
