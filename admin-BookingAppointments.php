...
<?php include("admin-topbar.php");?>
	...
	<div class="content transition">
		<div class="container-fluid dashboard">
                <h6 class="mb-0 text-center" style="font-size: 50px; font-family: 'Sacramento', cursive; color: #7E007F;">Booking appointments</h6> <br>
                        ...
                        <div class="table-wrapper">
                            <div class="table-title ">
                                <div class="row">
                                    <div class="col-sm-12 text-center">
                                        <h2>Today's <b>Apppointments</b></h2>
                                    </div>
                            ...
                            <table class="table table-striped table-hover">
                                <?php
                                    ...
                                    $query = "SELECT * FROM tbl_bookingappointment WHERE Appointment_date = '$today_date'";
                                    ...
                                    if ($result && $result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            echo "<tr>
                                                    ...
                                                    <td style='display: flex; gap: 10px;'>
                                                        <a href='admin-confirm_booking.php?ordernum=".urlencode($row['Ref_No'])."&SuccessBack=admin-BookingAppointments.php' class='confirm' title='Completed' data-toggle='tooltip'>
                                                            <i class='material-icons' style='color: green;'>&#xE8DC;</i>
                                                        </a>
                                                        <a href='admin-confirm_noShow.php?BookingNo=" . urlencode($row['Ref_No']) . "&ViewBack=admin-BookingAppointments.php' 
                                                            class='confirm' 
                                                            title='No Show' 
                                                            data-toggle='tooltip'
                                                        ...
                                                        <a href='admin-view_appointment.php?BookingNo=".urlencode($row['Ref_No'])."&ViewBack=admin-BookingAppointments.php' class='settings' title='View' data-toggle='tooltip'><i class='material-icons'>&#xE8F4;</i></a>
                                                        <a href=\"javascript:void(0);\" onclick=\"if(confirm('Are you sure you want to cancel this appointment?')) { window.location.href='admin-delete_appointment.php?BookingNo=".urlencode($row['Ref_No'])."&DelBack=admin-BookingAppointments.php'; }\" class='delete' title='Cancel appointment' data-toggle='tooltip'><i class='material-icons'>&#xE5C9;</i></a>
                                        ...
                                        echo "<tbody><tr><td colspan='7' style='text-align:center;'><b>You do not have a scheduled appointment today</b></td></tr></tbody>";
                                    }
                                ?>
                            </table>
                    ...
                    <div class="table-responsive">
                        <div class="table-wrapper">
                            <div class="table-title">
                                <div class="row">
                                    <div class="col-sm-7">
                                        <h5><b>Scheduled Apppointments </b><br>for the next 7 days</h5>
                                    </div>
                                    <div class="col-sm-5">
                                        <div style="display: flex; justify-content: center; align-items: center; padding: 10px;">
                                            <label style="font-size: 18px; color: white; margin-right: 10px;" for="date-picker">Search by date:</label>
                                            ...
                                            <!-- Search Button -->
                                            <a href='#' id="search-button" class='btn btn-outline-primary rounded' 
                                            style='font-size: 12px; background-color: #7E007F; border-radius: 20px; padding: 6px 20px; color: white; border: 2px solid white; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);'>
                                                Search
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <table class="table table-striped table-hover">
                                <?php
                                    ...
                                    $query = "SELECT * FROM tbl_bookingappointment 
                                            WHERE STR_TO_DATE(Appointment_date, '%d/%m/%Y') 
                                            BETWEEN STR_TO_DATE('$start_date', '%d/%m/%Y') 
                                            AND STR_TO_DATE('$end_date', '%d/%m/%Y')
                                            ORDER BY STR_TO_DATE(Appointment_date, '%d/%m/%Y') ASC";
                                    ...
                                    if ($result && $result->num_rows > 0) {
                                        ...
                                        echo "<tbody><tr><td colspan='7' style='text-align:center;'><b>You do not have a scheduled appointment in the next 7 days</b></td></tr></tbody>";
                                    }
                                ?>
                            </table>
