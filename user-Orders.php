                    ...
                    <div class="table-responsive">
                        <div class="table-wrapper">
                            <div class="table-title">
                                <div class="row">
                                    <div class="col-sm-5">
                                        <h2><i class="fas fa-archive fa-lg"></i> My <b>Orders</b></h2>
                                    </div>
                                </div>
                            </div>
                            <table class="table table-striped table-hover">
                                <?php
                                    ...
                                    $query = "SELECT * FROM tbl_orderhistory WHERE email = '$email' AND status = 'Ready for pick up'";
                                        ...
                                        if ($count > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href='user-view_orderhist.php?ordernum=".urlencode($row['Ref_No'])."' class='settings' title='View order' data-toggle='tooltip'><i class='material-icons'>&#xE8F4;</i></a>
                                                            <a href='user-delete_orders.php?ordernum=" . urlencode($row["Ref_No"]) . "' class='delete' title='Cancel order' data-toggle='tooltip' onclick=\"return confirm('Are you sure you want to cancel this order?');\">
