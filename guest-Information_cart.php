...
include("guest-Information_cart_process.php"); 
                                    ...
                                    <div class="well">
                                        <form method="post">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <a href="guest-Cart.php" class="btn btn-outline-primary btn-lg rounded w-50 me-2 mt-3">Back</a>
                                                <input type="submit" class="btn btn-primary btn-lg rounded w-50 ms-2 mt-3" style="width: 100%;" value="Next" name="submit">
                                            </div>
                                        </form>
                                        </div>
                                    </div>
