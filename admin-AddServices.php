...
<?php 
    ...
    include("admin-AddServices_process.php");
...
<?php include("admin-topbar.php");?>
    ...
    <div class="content transition text-center">
        ...
        <h6 class="mb-0" style="font-size: 50px; font-family: 'Sacramento', cursive; color: #7E007F;">
            Add New Services
        </h6> 
                                    ...
                                    <div class="col-sm-9">
                                        <div class="well">
                                            ...
                                            <form method="post" enctype="multipart/form-data" style="text-align: center;">
                                                <img id="avatar" src="Photos/Services/SERVICE_DEFAULT.jpg" style="width: 3.5in; height: 2in; object-fit: cover;">
                                                <br><br>
                                                ...
                                                <select class="form-control" name="therapy">
                                                    <option value="Remedial Massage Therapy">Remedial Massage Therapy</option>
                                                    <option value="Bowen Therapy">Bowen Therapy</option>
                                                ...
                                                <input type="text" class="form-control" name="servicetitle" placeholder="Enter text here">
                                                <br>
                                                ...
                                                <textarea class="form-control" name="servicedesc" rows="4" cols="50" placeholder="Enter text here"></textarea>
                                                <br>
                                                ...
                                                <input type="text" class="form-control" name="serviceprice" placeholder="Enter text here">
                                                <br>
                                                ...
                                                <input type="text" class="form-control" name="serviceduration" placeholder="Enter text here">
                                                <br>
