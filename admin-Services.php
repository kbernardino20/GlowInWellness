...
<?php include("admin-topbar.php");?>
	...
	<div class="content transition">
		<div class="container-fluid dashboard">
                ...
                <h6 class="mb-0 text-center" style="font-size: 50px; font-family: 'Satisfy', cursive; color: #7E007F;">Glow in Wellness Services</h6> <br>
                <br>
				<h6 class="mb-0 text-center" style="font-size: 20px; cursive; color: #7E007F;">Remedial Massage Therapy</h6> <br>
				<?php
									...
									<div class='card-body'>
										<div class='row'>
											...
											<div class='col-8'>
												...
												<a href='admin-UpdateServices.php?selectedservice=".urlencode($row['service'])."' class='btn btn-primary btn-lg rounded w-md mt-3' style='font-size: 12px;'>Update Info</a>
												<a href='javascript:void(0);' onclick='confirmDelete(\"" . urlencode($row['service']) . "\")' class='btn btn-outline-primary btn-lg rounded w-md mt-3' style='font-size: 12px;'>Delete</a>
											</div>
										</div>
									</div>
								</div>
...
function confirmDelete(service) {
    if (confirm("Are you sure you want to delete this service?")) {
        window.location.href = 'admin-DeleteServices.php?selectedservice=' + service;
    }
}
</script>
