...
<?php 
    ...
    include("admin-AddProducts_process.php");
                                    ...
                                    <div class="col-sm-9">
                                        <div class="well">
                                            ...
                                            <form method="post" enctype="multipart/form-data" style="text-align: center;">
                                                <img id="avatar" src="Photos/Products/PRODUCT_DEFAULT.jpg" style="width: 2in; height: 2in; object-fit: cover;">
                                                <br><br>
                                                ...
                                                <label style="color: #7E007F;" for="itemcategory">Category</label>
                                                ...
                                                <br>
                                                <label style="color: #7E007F;" for="product_name">Product name</label>
                                                <?php echo isset($prd_error) ? "<br><h10 style='color:red; font-size: 10px;'>" . $prd_error . "</h10>" : "" ?>
                                                <input type="text" class="form-control" name="product_name" placeholder="Enter text here">
                                                ...
                                                <input type="text" class="form-control" name="Productprice" placeholder="Enter text here">
                                                <br>
