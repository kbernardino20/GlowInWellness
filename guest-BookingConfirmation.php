...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <div class="content transition text-center">
        ...
        Select Service > Select a date > Select time > Information > Summary >
        </label>
        <label style="color: #ffffff;">
            <a href="#" style="color: #ffffff; text-decoration: none;"><b> Confirmation </b></a>
        </label>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center p-4" style="font-family: Arial, sans-serif; background-color: #f8f8f8; border-radius: 12px; margin: 0 auto;">
                                ...
                                <div style="font-size: 16px; color: #777;">Your confirmation number:</div>
                            ...
                            <div class="text-center">
                                <a href="user-homepage.php" class="btn btn-outline-primary btn-lg rounded w-100 mt-4" style="font-size: 20px;">Start new Booking</a>
                            </div>
                        </div>
                    </div>
                </div>
